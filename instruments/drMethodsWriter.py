...
def main(batchConfigYaml: Dict, configDir: DirectoryPath, outDir: DirectoryPath) -> None:
    ...
    with open(methodsFile, "w") as f:
        ...
        f.write("**This methods section was automatically generated by drMD**\n\n")
...
def write_generic_simulation_methods(methodsFile, simulationInfo):
    with open(methodsFile, "a") as methods:
        ...
        methods.write(f"All simulations were performed using the Langevin Middle Intergrator \
...
def cite(key) -> str:
    ...
    if isinstance(citation, list):
        citation = ["https://doi.org/"+ref for ref in citation]
    elif isinstance(citation, str):
        citation = ["https://doi.org/"+citation]
